...
import sos.etsiinf.upm.es.WineSocialUPMStub.*;
import sos.etsiinf.upm.es.WineSocialUPMCallbackHandler.*;
...
public class WineClient {
    ...
    public static void main(String[] args) {
        ...
        boolean exit = false;
        String serviceURL = "http://127.0.0.1:8080/axis2/services/WineSocialUPM";
        WineSocialUPMStub stub = new WineSocialUPMStub(serviceURL);
        //stub._getServiceClient().getOptions().setUseSeparateListener(true);
        WineSocialUPMCallbackHandler callback = null ;
        ...
        while (!exit) {
            ...
            try {
                ...
                case 1:
                    ...
                    System.out.println(addUserResponse.get_return().getResponse());
